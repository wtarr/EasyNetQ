...
namespace EasyNetQ
{
    ...
    public interface IPullingConsumerFactory
    {
        ...
        /// <returns></returns>
        IPullingConsumer<PullResult> CreateConsumer(in Queue queue, PullingConsumerOptions options);
        ...
        /// <param name="options">The options</param>
        /// <returns></returns>
        IPullingConsumer<PullResult<T>> CreateConsumer<T>(in Queue queue, PullingConsumerOptions options);
    }
    ...
    public class PullingConsumerFactory : IPullingConsumerFactory
    {
        ...
        /// <inheritdoc />
        public IPullingConsumer<PullResult> CreateConsumer(in Queue queue, PullingConsumerOptions options)
        {
        ...
        /// <inheritdoc />
        public IPullingConsumer<PullResult<T>> CreateConsumer<T>(in Queue queue, PullingConsumerOptions options)
        {
